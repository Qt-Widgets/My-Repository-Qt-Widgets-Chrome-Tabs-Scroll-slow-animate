...
QT_MOC_LITERAL(3, 16, 13), // "requestUpdate"
QT_MOC_LITERAL(4, 30, 23), // "onPreviousMatchFinished"
QT_MOC_LITERAL(5, 54, 15) // "onTimerFinished"

    },
    "Match\0finished\0\0requestUpdate\0"
    "onPreviousMatchFinished\0onTimerFinished"
};
...
void Match::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->onPreviousMatchFinished(); break;
        case 3: _t->onTimerFinished(); break;
        default: ;
        }
        ...
        {
            using _t = void (Match::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Match::finished)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Match::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Match::requestUpdate)) {
                *result = 1;
                return;
            }
        }
