...
QT_MOC_LITERAL(4, 29, 6), // "winner"
QT_MOC_LITERAL(5, 36, 13), // "requestUpdate"
QT_MOC_LITERAL(6, 50, 15), // "onRoundFinished"
QT_MOC_LITERAL(7, 66, 20), // "onRoundMatchFinished"
QT_MOC_LITERAL(8, 87, 6), // "Match*"
QT_MOC_LITERAL(9, 94, 1), // "m"
QT_MOC_LITERAL(10, 96, 19) // "onRoundMatchStarted"

    },
    "Tournament\0finished\0\0Player*\0winner\0"
    "requestUpdate\0onRoundFinished\0"
    "onRoundMatchFinished\0Match*\0m\0"
    "onRoundMatchStarted"
};
...
void Tournament::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->finished((*reinterpret_cast< Player*(*)>(_a[1]))); break;
        case 1: _t->requestUpdate(); break;
        case 2: _t->onRoundFinished(); break;
        case 3: _t->onRoundMatchFinished((*reinterpret_cast< Match*(*)>(_a[1]))); break;
        case 4: _t->onRoundMatchStarted((*reinterpret_cast< Match*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (Tournament::*)(Player * );
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Tournament::requestUpdate)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Tournament::finished(Player * _t1)
{
